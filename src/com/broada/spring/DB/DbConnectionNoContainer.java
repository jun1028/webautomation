...
public class DbConnectionNoContainer {
	...
	private static void init() {
		...
		activeCountstr = silencerProperties.getString("activeCount");
		dbAlias = silencerProperties.getString("dbAlias");
		dbDriver = silencerProperties.getString("dbDriver");
		dbUrl = silencerProperties.getString("dbUrl");
		dbUser = silencerProperties.getString("dbUser");
		dbPwd = silencerProperties.getString("dbPwd");
		minConnstr = silencerProperties.getString("minConn");
		maxConnstr = silencerProperties.getString("maxConn");
		log = LogFactory.getLog(DbConnectionNoContainer.class);
